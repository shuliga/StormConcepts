...
import com.shl.poc.storm.starter.bolt.IntermediateRankingsBolt;
import com.shl.poc.storm.starter.bolt.RollingCountBolt;
import com.shl.poc.storm.starter.bolt.TotalRankingsBolt;
import com.shl.poc.storm.starter.util.StormRunner;
import com.shl.poc.strom.spout.HttpServerQueueSpout;
...
//    conf.setDebug(true);
  ...
  private void wireTopology() throws InterruptedException {
    ...
    builder.setSpout(spoutId, new HttpServerQueueSpout(), 5);
